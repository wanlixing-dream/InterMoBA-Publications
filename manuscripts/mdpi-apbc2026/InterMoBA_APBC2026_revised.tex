...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig1bc.png}
    \caption{\small
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig4abc.png}
    \caption{%
...
\end{tabular}}
\bigskip
{\small \textbf{Table 1:} Performance comparison on time-split PDBBind. Blind docking results from DiffDock paper; pocket-specified results from Interformer paper. Bold: best.}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig2abcd.png}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig2ef.png}
    \caption{
