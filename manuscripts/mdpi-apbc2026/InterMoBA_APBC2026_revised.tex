...
\begin{figure}[H]
    ...
    \caption{
        ...
        \textbf{b} Predicted ligand pose (PDB ID: 3g2n) overlaid with the crystallographic pose, with hydrogen-bond interactions annotated. Inset details the donor-acceptor pairs (RMSD = 0.332 \AA). Top-right: five predicted MDN distributions; colors indicate hydrogen bonds (yellow, green, red) and non-interacting pairs (purple, blue).
    }
